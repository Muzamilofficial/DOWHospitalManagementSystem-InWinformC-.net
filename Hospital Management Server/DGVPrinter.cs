...
{    
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            titlefont = new Font("Tahoma", 25, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.DarkRed;
            subtitlefont = new Font("Tahoma", 18, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.DarkGreen;
            footerfont = new Font("Tahoma", 16, FontStyle.Bold, GraphicsUnit.Point);
            footercolor = Color.MidnightBlue;
        ...
        public bool ProportionalColumns { get; set; }
    }
}
